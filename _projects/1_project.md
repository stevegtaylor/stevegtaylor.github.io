...
The BRASS system was runner-up at the 2022 UCSC launchpad competition.

I was the mechanical design and community outreach lead.
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/BRASS Bike and lock.jpg" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    The BRASS proof of concept deployed on a bicycle.
</div>
